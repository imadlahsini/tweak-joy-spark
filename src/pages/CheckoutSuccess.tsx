...
const CheckoutSuccess = () => {
  ...
  useEffect(() => {
    ...
    // Fire-and-forget: save the order to the database
    supabase.functions
      .invoke("save-order", { body: { session_id: sessionId } })
      .then(({ error }) => {
    ...
    <div className="min-h-screen bg-background relative overflow-hidden flex items-center justify-center px-4">
      ...
      >
        ...
        <p className="text-muted-foreground mb-8">
          Thank you for your purchase. We'll be in touch shortly to get started on your SEO journey.
        </p>
        <Button asChild>
          <Link to="/">
